...
function biterrunanimation(scale, tint1, tint2, animation_speed)
	if not animation_speed then
		animation_speed = 1
	end
	return {
		layers = {
...
function biteridleanimation(scale, tint1, tint2)
	-- this is a temporary solution until someone makes me idle animations
	-- change idle animation speed here
	return biterrunanimation(scale, tint1, tint2, 0.1)
end

function bitergunanimation(scale, tint1, tint2, animation_speed)
	if not animation_speed then
		animation_speed = 1
	end
	-- TODO: finish bitergunanimation
end

function biterdieanimation_FAKE(scale, tint1, tint2)
	return {
		layers = {
			{
				filenames = {
