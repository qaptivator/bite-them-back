...
function make_heat_pipe_pictures(path, name_prefix, data, draw_as_glow)
	...
	for key, t in pairs(data) do
		if t.empty then
			all_pictures[key] =
				{ priority = "extra-high", filename = "__core__/graphics/empty.png", width = 1, height = 1 }
		else
			local tile_pictures = {}
	...
	return {
		...
		orientations = {
			...
			west_to_north = cliff_orientation(
				...
				3,
				8,
				rotbb(-5 / 4, -3 / 4, dq(5.4), dq(3.6), 7 / 8),
				scale,
				fill_volume * 2
			),
			north_to_east = cliff_orientation(
				...
				0,
				8,
				rotbb(5 / 4, -3 / 4, dq(5.4), dq(3.6), 1 / 8),
				scale,
				fill_volume * 2
			),
			east_to_south = cliff_orientation(
				...
				1,
				8,
				rotbb(3 / 4, 5 / 4, dq(4.4), dq(2.6), 7 / 8),
				scale,
				fill_volume * 2
			),
			south_to_west = cliff_orientation(
				...
				2,
				8,
				rotbb(-3 / 4, 5 / 4, dq(4.4), dq(2.6), 1 / 8),
				scale,
				fill_volume * 2
			),
			...
			north_to_none = cliff_orientation(
				...
				3,
				2,
				rotbb(0.75, -0.75, dq(4.5), dq(2.5), 1 / 8),
				scale,
				fill_volume
			),
			...
			none_to_north = cliff_orientation(
				...
				1,
				2,
				rotbb(-0.70, -0.70, dq(4.5), dq(2.5), 7 / 8),
				scale,
				fill_volume
			),
		},
...
data:extend({
	...
	},
	{
		...
		rocket_sprite = util.add_shift_offset(
			util.by_pixel(0, 32 * 3.5), --util.mul_shift(rocket_rise_offset, -1),
			{
...
for name, picture in pairs(infinity_pipe.pictures) do
	if
		...
		and name ~= "middle_temperature_flow"
